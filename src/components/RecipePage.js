...
const RecipePage = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://h3x2y9-5000.csb.app/api/recipes/${id}`)
      .then((response) => {
  ...
  const handleSubmit = () => {
    axios
      .post(
        `https://h3x2y9-5000.csb.app/api/recipes/${id}/comments`,
        {
      ...
      <Card style={{ paddingTop: 10 }}>
        <CardMedia
          ...
          style={{
            ...
            backgroundImage: `url(https://h3x2y9-5000.csb.app/${recipe.image})`,
